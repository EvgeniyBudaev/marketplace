...
import type { ETableSortDirection, ETheme } from "#app/uikit";
...
type TTableSettingsProps<TColumn extends object> = Omit<
  TSettingsProps<TColumn>,
  "columns"
>;
...
export type TTableSortingParams =
  | TTableSortingColumnState
  | Array<TTableSortingColumnState>;
