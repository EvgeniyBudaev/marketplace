...
import type { TSortingColumnStateWithReset } from "#app/uikit/components/Table/TableHeader/index";
...
export const TableHeader = <T extends object>({
  ...
  const handleChangeSorting = (
    ...
    const { sortDirection, sortProperty } =
      value as TSortingColumnStateWithReset;
