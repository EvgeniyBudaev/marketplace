...
export const iconTypes = new Map([
  ...
  ["AdminPanel", <AdminPanelIcon key="AdminPanel" />],
  ...
  [
    "ArrowDropDownStroke",
    <ArrowDropDownStrokeIcon key="ArrowDropDownStroke" />,
  ],
  ...
  ["MoreVertical", <MoreVerticalIcon key="MoreVertical" />],
  ["NoImage", <NoImageIcon key="NoImage" />],
