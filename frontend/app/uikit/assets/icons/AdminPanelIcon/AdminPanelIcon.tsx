...
const AdminPanelIconComponent: FC<TProps> = ({className, height = 24, width = 24, onClick, ...props}) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" height={height} viewBox="0 -960 960 960" width={width}
