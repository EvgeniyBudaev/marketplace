...
import type { TForm } from "#app/pages/Admin/Attributes/AttributeEdit";
import {
  addSelectableValue,
...
import type { TAttributeDetail } from "#app/shared/api/attributes";
...
export const meta: MetaFunction = ({ data }) => {
  if (typeof window !== "undefined") {
    return [
      {
        title:
          i18next.t("routes.titles.attributeEdit") || "Editing an Attribute",
      },
    ];
  }
