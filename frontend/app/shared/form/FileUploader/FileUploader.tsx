...
import {
  Previews,
  previewsLinks,
} from "#app/shared/form/FileUploader/Previews";
import {
  filterDuplicatedFiles,
  getTypes,
} from "#app/shared/form/FileUploader/utils";
import type { TFile } from "#app/types";
import { Button, Dropzone, ETypographyVariant, Typography } from "#app/uikit";
    ...
    <div className="FileUploader">
      ...
      >
        <div className="FileUploader-Dropzone-Inner">
          ...
          <Button className="FileUploader-Dropzone-Button">
