...
export type TAttributeDeleteParams = z.infer<
  typeof attributeDeleteParamsSchema
>;
export type TAttributeDelete = z.infer<typeof attributeDeleteSchema>;

export type TAttributeDetailParams = z.infer<
  typeof attributeDetailParamsSchema
>;
...
export type TSelectableValueEditParams = z.infer<
  typeof selectableValueEditParamsSchema
>;
export type TSelectableValueEdit = z.infer<typeof selectableValueEditSchema>;

export type TSelectableValueDeleteParams = z.infer<
  typeof selectableValueDeleteParamsSchema
>;
export type TSelectableValueDelete = z.infer<
  typeof selectableValueDeleteSchema
>;

export type TSelectableValueAddParams = z.infer<
  typeof selectableValueAddParamsSchema
>;
export type TSelectableValueAdd = z.infer<typeof selectableValueAddSchema>;

export type TAttributesByCatalogParams = z.infer<
  typeof attributesByCatalogParamsSchema
>;
