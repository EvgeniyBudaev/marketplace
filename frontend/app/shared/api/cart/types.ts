...
} from "#app/shared/api/cart/schemas";
...
export type TCartItemIncrementParams = z.infer<
  typeof cartItemIncrementParamsSchema
>;
export type TCartItemDecrementParams = z.infer<
  typeof cartItemDecrementParamsSchema
>;
export type TCartItemRemoveParams = z.infer<typeof cartItemRemoveParamsSchema>;
export type TCartItemSetQuantityParams = z.infer<
  typeof cartItemSetQuantityParamsSchema
>;
