...
import { EFormFields, formSchema } from "#app/components/search";
import type { TForm } from "#app/components/search";
import { EFormMethods, Form, useInitForm } from "#app/shared/form";
