...
import { checkPermission, createPath } from "#app/utils";
...
export const HeaderIconsList: FC = () => {
  ...
  const isAdmin = checkPermission(user?.permissions ?? null, [
  ...
  return (
    <div className="HeaderIconsList">
      ...
      <div
        className={clsx("HeaderIconsList-Item", "HeaderIconsList-ItemDesktop")}
      >
        {!isEmpty(user) ? (
          <div className="HeaderIconsList-AvatarDropDown">
            <DropDown>
              ...
              <DropDown.Panel
                classes={{ dropDownPanel: "HeaderIconsList-DropDownUser" }}
              >
