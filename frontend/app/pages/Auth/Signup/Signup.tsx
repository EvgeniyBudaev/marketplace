...
import { useTranslatedForm, useTranslatedResolver } from "#app/hooks";
import { EFormMethods, Form, Input, useInitForm } from "#app/shared/form";
import { EFormFields } from "#app/pages/Auth/Signup/enums";
import { formSchema } from "#app/pages/Auth/Signup/schemas";
import type { TForm, TOptionsSubmitForm } from "#app/pages/Auth/Signup/types";
...
import { createPath, normalizePhoneNumber } from "#app/utils";
        ...
        <div className="Signup-Content">
          ...
          >
            <div className="Signup-FormFieldGroup">
              ...
              <Input
                label={
                  t("form.passwordConfirm.title") ?? "Password confirmation"
                }
