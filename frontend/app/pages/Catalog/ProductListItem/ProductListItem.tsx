...
export const ProductListItem = forwardRef<HTMLLIElement, TProps>(
  function ProductListItem(
    ...
    const ROUTE_PRODUCT_DETAIL = createPath({
      ...
      params: {
        aliasCatalog: product.catalogAlias,
      ...
      >
        <div className="ProductListItem-Wrapper">
          <div className="ProductListItem-Content">
            ...
            >
              <Link
                className="ProductListItem-ContentLink"
          ...
          <div className="ProductListItem-Footer">
            ...
            {count > 0 && (
              <div className="ProductListItem-FooterAddToCart">
