...
import { modalPaymentMethodLinks } from "~/pages/Order/ModalPaymentMethod";
        ...
        <div className="OrderPayment-Info">
          {paymentMethod === EPaymentMethod.CARD ? (
            <>
              ...
              <div>
                <Typography variant={ETypographyVariant.TextB3Regular}>{CARD_TEXT}</Typography>
              </div>
            </>
          ) : (
            <>
              ...
              <div>
                <Typography variant={ETypographyVariant.TextB3Regular}>{CASH_TEXT}</Typography>
              </div>
            </>
          )}
        </div>
