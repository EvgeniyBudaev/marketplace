...
import {
  RadioCard,
  radioCardLinks,
} from "#app/pages/Order/ModalPaymentMethod/RadioCard";
import { Button, Icon, Modal, Typography } from "#app/uikit";
...
export const ModalPaymentMethod: FC<TProps> = ({
  isOpen,
  onClose,
  onSubmit,
}) => {
  ...
  const [preliminaryPaymentMethod, setPreliminaryPaymentMethod] = useState(
    EPaymentMethod.CARD
  );
  ...
  return (
    ...
    >
      ...
      <Modal.Content>
        <div
          className={clsx(
            "ModalPaymentMethod-Inner ModalPaymentMethod-InnerMobile"
          )}
        >
          <RadioCard
