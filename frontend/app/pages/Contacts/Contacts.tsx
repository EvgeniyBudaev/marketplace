...
export const Contacts: FC = () => {
  return (
    <section className="Contacts">
      ...
      <div>
        <p className="Contacts-Paragraph">ИНДИВИДУАЛЬНЫЙ ПРЕДПРИНИМАТЕЛЬ ИВАНОВ ИВАН ИВАНОВИЧ</p>
        <p className="Contacts-Paragraph">
          <strong>Юридический адрес организации: </strong>143409, Россия, Московская область, г.
