    ...
    <section className="Delivery">
      ...
      <p className="Delivery-Paragraph">
        <Typography variant={ETypographyVariant.TextB3Regular}>
          ...
          в корзину, а затем перейдите на страницу Корзина, проверьте
          правильность заказанных позиций и нажмите кнопку «Перейти к
          оформлению». Процесс оформления состоит из трёх шагов:
        </Typography>
      </p>
      ...
      <p className="Delivery-Paragraph">
        <Typography variant={ETypographyVariant.TextB3Regular}>
          Заполните обязательное поле адрес доставки или выберите адрес на
          карте. Дополнительно можете указать номер квартиры, этажа, подъезда,
          домофона и оставить комментарий для курьера.
        </Typography>
      </p>
      <h4 className="Delivery-SubTitle">
        <Typography variant={ETypographyVariant.TextH4Medium}>
      ...
      <p className="Delivery-Paragraph">
        <Typography variant={ETypographyVariant.TextB3Regular}>
          ...
          следующий раз предложит вам повторить к вводу данные предыдущего
          заказа.
        </Typography>
      </p>
    </section>
