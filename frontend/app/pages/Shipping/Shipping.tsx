...
import { EFormFields } from "#app/pages/Shipping/enums";
import type { TForm, TOptionsSubmitForm } from "#app/pages/Shipping/types";
import { formSchema } from "#app/pages/Shipping/schemas";
import type { TGeoSearchSuggestion } from "#app/pages/Shipping/YMap/GeoSearch";
import type { TPickMapState } from "#app/pages/Shipping/YMap/PickMap";
import PickMap from "#app/pages/Shipping/YMap/PickMap/PickMap";
import {
  YMapFormField,
  yMapFormFieldLinks,
} from "#app/pages/Shipping/YMapFormField";
import { Marker } from "#app/pages/Shipping/YMap/Marker";
import { yMapLinks } from "#app/pages/Shipping/YMap/YMap";
...
import type { TDomainErrors, TParams } from "#app/types";
import {
  Button,
  ETypographyVariant,
  Icon,
    ...
    <section className="Shipping">
      ...
      >
        <div className="Shipping-FormContent">
          ...
          <div
            className={clsx(
              "Shipping-FormFieldGroup",
              "Shipping-FormFieldCouple"
            )}
          >
            <Input
          ...
          <div className="Shipping-FormFieldGroup">
            <Textarea
              ...
              label={
                t("form.commentForCourier.title") ?? "Comment for the courier"
              }
