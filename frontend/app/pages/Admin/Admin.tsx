  ...
  return (
    <section>
      <h1 className="Admin-Title">
        <Typography variant={ETypographyVariant.TextH1Bold}>{t("pages.admin.title")}</Typography>
      </h1>
      <div>
        <LinkButton href="/admin/catalogs">{t("pages.admin.link.catalogs")}</LinkButton>
      </div>
      <div>
        <LinkButton href="/admin/products">{t("pages.admin.link.products")}</LinkButton>
      </div>
      <div>
