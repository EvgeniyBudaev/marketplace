...
import { useGetColumns } from "#app/pages/Admin/Attributes/AttributesTable";
import type { TTableColumn } from "#app/pages/Admin/Attributes/AttributesTable/types";
import type { TAttributes, TAttribute } from "#app/shared/api/attributes";
    ...
    return (
      <div ref={ref}>
        <UiTable<TAttribute>
          ...
          totalItemsTitle={
            t("pages.admin.attributes.table.header") ?? "Total attributes"
          }
        />
      </div>
    );
