...
import type { TTableColumn } from "#app/pages/Admin/Products/ProductsTable/types";
import { useGetColumns } from "#app/pages/Admin/Products/ProductsTable/hooks";
import type { TProducts, TProduct } from "#app/shared/api/products";
    ...
    return (
      <div ref={ref}>
        <UiTable<TProduct>
          ...
          totalItemsTitle={
            t("pages.admin.products.table.header") ?? "Total products"
          }
        />
      </div>
    );
