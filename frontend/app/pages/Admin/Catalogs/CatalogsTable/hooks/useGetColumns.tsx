...
import { TableCellImage, TableHeader } from "#app/components";
import { ETableColumns } from "#app/pages/Admin/Catalogs/CatalogsTable";
    ...
    () =>
      [
        columnHelper.accessor(ETableColumns.Image, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.image")}
            </TableHeader>
          ),
          cell: (data) => {
        ...
        columnHelper.accessor(ETableColumns.Name, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.name")}
            </TableHeader>
          ),
          minSize: 192,
        }),
        ...
        columnHelper.accessor(ETableColumns.Alias, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.alias")}
            </TableHeader>
          ),
          minSize: 192,
        }),
        ...
        columnHelper.accessor(ETableColumns.Enabled, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.status")}
            </TableHeader>
          ),
        }),
        ...
        columnHelper.accessor(ETableColumns.CreatedAt, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.dateAdded")}
            </TableHeader>
          ),
          cell: (data) => {
            const value = data.getValue();
        ...
        columnHelper.accessor(ETableColumns.ModifyDate, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.catalogs.table.columns.info.dateOfChange")}
            </TableHeader>
          ),
          cell: (data) => {
            const value = data.getValue();
