...
import { EFormFields, formSchema } from "#app/pages/Admin/Orders/OrderEdit";
import type {
  TForm,
  TOptionsSubmitForm,
} from "#app/pages/Admin/Orders/OrderEdit";
import { mapOrderEditToDto } from "#app/pages/Admin/Orders/OrderEdit/utils";
import {
  orderEditProductsTableLinks,
  OrderEditProductsTable,
} from "#app/pages/Admin/Orders/OrderEditProductsTable";
...
import { Button, ETypographyVariant, notify, Typography } from "#app/uikit";
...
export const OrderEdit: FC<TProps> = (props) => {
  ...
  const selectStatusOptions = [
    { value: order.status.id.toString(), label: order.status.name },
  ];
  const selectPaymentVariantOptions = [
    {
      value: order.paymentVariant.id.toString(),
      label: order.paymentVariant.name,
    },
  ];
