...
import { ETableColumns } from "#app/pages/Admin/Orders/OrderEditProductsTable/enums";
    ...
    () =>
      [
        columnHelper.accessor(ETableColumns.Id, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.orderEdit.table.columns.info.id")}
            </TableHeader>
          ),
        }),
        ...
        columnHelper.accessor(ETableColumns.Name, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.orderEdit.table.columns.info.name")}
            </TableHeader>
          ),
          minSize: 192,
        }),
        ...
        columnHelper.accessor(ETableColumns.Quantity, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.orderEdit.table.columns.info.quantity")}
            </TableHeader>
          ),
          minSize: 192,
        }),
        ...
        columnHelper.accessor(ETableColumns.Price, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.orderEdit.table.columns.info.price")}
            </TableHeader>
          ),
          minSize: 192,
        }),
        ...
        columnHelper.accessor(ETableColumns.Amount, {
          ...
          header: () => (
            <TableHeader>
              {t("pages.admin.orderEdit.table.columns.info.amount")}
            </TableHeader>
          ),
          minSize: 192,
        }),
