...
import { useLanguage, useTheme } from "#app/hooks";
import {
  SettingSelectControl,
  settingSelectControlLinks,
} from "#app/pages/Settings/SettingSelectControl";
import {
  SettingSelectOption,
  settingSelectOptionLinks,
} from "#app/pages/Settings/SettingSelectOption";
    ...
    if (Array.isArray(selectedOption)) {
      ...
      socket &&
        socket.emit(
          ...
          selectedOptionSingle.value as ELanguages
        );
    ...
    <section className="Settings">
      ...
      <div className="Settings-Block">
        <Select
          ...
          components={{
            Control: SettingSelectControl,
            Option: SettingSelectOption,
          }}
          isMulti={false}
